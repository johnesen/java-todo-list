...
import com.todoapp.project.entity.Course;
import com.todoapp.project.repositories.CourseRepository;
...
public class CourseService {
    ...
    public Course saveCourseForUsername(Course course) {
        System.out.println(course.toString());
        return courseRepository.save(course);
    }
